(function ($) {
    ...
    script.app = {
        ...
        weatherStatu:function(){
            if($(".small").text()=="Rain"){
                $(".breezy").removeClass("d-none");
                $(".cloudy").addClass("d-none");
                $(".stormy").addClass("d-none");
                $(".hot").addClass("d-none");
            }
            if($(".small").text()=="Clouds"){
                $(".hot").addClass("d-none");
                $(".breezy").addClass("d-none");
                $(".stormy").addClass("d-none");
                $(".cloudy").removeClass("d-none");
            }
            if($(".small").text()=="Snow"){
                $(".breezy").addClass("d-none");
                $(".cloudy").addClass("d-none");
                $(".stormy").removeClass("d-none");
                $(".hot").addClass("d-none");

            }
            
            if($(".small").text()=="Thunderstorm"){
                $(".breezy").removeClass("d-none");
                $(".cloudy").addClass("d-none");
                $(".stormy").addClass("d-none");
                $(".hot").addClass("d-none");
        ...
        weatherApp: function(){
            const apiKey = "7a1e1214fe9ebf71870428cc4ddca6ca";
            ...
            function addWeatherToPage(data) {
                ...
                <small class='small'>${data.weather[0].main}</small>  
                `;
                //  cleanup   
                main.innerHTML = "";
